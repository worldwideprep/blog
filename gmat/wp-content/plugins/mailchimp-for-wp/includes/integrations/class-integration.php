...
abstract class MC4WP_Integration {
	...
	public function get_checkbox_html() {
		...
		<input type="checkbox" id="id_<?php echo esc_attr( $this->checkbox_name ); ?>" name="<?php echo esc_attr( $this->checkbox_name ); ?>" value="1" <?php echo $this->get_checkbox_attributes(); ?> />
			<label for="id_<?php echo esc_attr( $this->checkbox_name ); ?>">
