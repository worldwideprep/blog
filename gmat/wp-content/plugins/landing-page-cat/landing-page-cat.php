...
if ( !defined('FCA_LPC_PLUGIN_DIR') ) {
	...
	define( 'FCA_LPC_PLUGIN_VER', '1.4.0' );
	...
	if ( file_exists ( FCA_LPC_PLUGIN_DIR . '/includes/splash/splash.php' ) ) {
		include_once( FCA_LPC_PLUGIN_DIR . '/includes/splash/splash.php' );
	}
...
function fca_lpc_compatibility_notices() {
...
add_action( 'admin_notices', 'fca_lpc_compatibility_notices' );	