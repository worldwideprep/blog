...
function fca_lpc_activecampaign_settings( $meta ) {
	...
	$html = "<tr class='fca_lpc_activecampaign_setting_row'>";
		$html .= "<th>" . __('URL', 'landing-page-cat') . fca_lpc_tooltip( __("Log in to AciveCampaign, then click your profile in the top right-hand side. Click My Settings, then Developer and paste your API Access URL here.", 'quiz-cat') ) . fca_lpc_spinner() . "</th>";
	...
	$html .= "<tr class='fca_lpc_activecampaign_setting_row'>";
		$html .= "<th>" . __('Key', 'landing-page-cat') . fca_lpc_tooltip( __("Log in to AciveCampaign, then click your profile in the top right-hand side. Click My Settings, then Developer and paste your API Access Key here.", 'quiz-cat') ) . "</th>";
		$html .= "<td>";
...
function fca_lpc_activecampaign_subscribe( $api_key, $api_url, $list, $tags, $email, $name ) {
	...
	$url = $api_url . "/admin/api.php?api_action=contact_add&api_output=json&api_key=$api_key";
